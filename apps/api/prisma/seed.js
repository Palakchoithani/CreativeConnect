...
async function main() {
    ...
    const recruiterHash = await bcryptjs_1.default.hash('Recruiter@123', 10);
    const designerHash = await bcryptjs_1.default.hash('Designer@123', 10);
    const photographerHash = await bcryptjs_1.default.hash('Photo@123', 10);
    const writerHash = await bcryptjs_1.default.hash('Writer@123', 10);
    const musicHash = await bcryptjs_1.default.hash('Music@123', 10);
    // 1. Create Users
